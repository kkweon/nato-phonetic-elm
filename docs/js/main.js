...
var $author$project$Main$initModel = {input: ''};
...
var $author$project$Main$ClearInputBox = {$: 'ClearInputBox'};
...
var $author$project$NatoPhonetic$natoPhonetic = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			_Utils_chr('A'),
...
var $author$project$Main$char2Nato = function (x) {
	var phoneticWord = function (c) {
		return A2($elm$core$Dict$get, c, $author$project$NatoPhonetic$natoPhonetic);
	}(
