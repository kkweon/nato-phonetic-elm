...
var _user$project$Main$concatListMaybeString = function (xs) {
	return A2(
		_elm_lang$core$String$join,
		'\r\n',
		A2(
		...
		return A2(
			...
			function (r) {
				return A2(
					...
					A2(_elm_lang$core$String$cons, x, ' -> '),
					r);
			},
			A2(_elm_lang$core$Dict$get, x, _user$project$NatoPhonetic$natoPhonetic));
	};
	return getter(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				target: _user$project$Main$concatListMaybeString(
					_user$project$Main$sentence2Nato(_p2._0))
			});
	});
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$placeholder('type sentence'),
					_1: {
						ctor: '::',
